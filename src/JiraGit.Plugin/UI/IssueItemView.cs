...
namespace JiraGit.Plugin.UI
{
	class IssueItemView : IIssue
	{
     ...
     //       Issue.ProcessWorklog(timeSpent, method, newTimeEstimate);
	    //}
		public void ProcessWorklog(string timeSpent, TimeEstimateRecalcualationMethod method, string newTimeEstimate, string comment = "Time logged")
		{
			Issue.ProcessWorklog(timeSpent, method, newTimeEstimate,comment);
		}
	}
}
