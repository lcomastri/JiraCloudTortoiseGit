namespace JiraGit.Plugin.UI
{
    partial class IssuesList
    {
      ...
      this._filters = new JiraGit.Plugin.UI.BindingComboBox();
      this._search = new System.Windows.Forms.TextBox();
      this._status = new JiraGit.Plugin.UI.BindingComboBox();
      this._assigned = new JiraGit.Plugin.UI.BindingComboBox();
      ...
      this._assignTo = new JiraGit.Plugin.UI.BindingComboBox();
      this._takeAction = new JiraGit.Plugin.UI.BindingComboBox();
      ...
      this._worklogAction = new JiraGit.Plugin.UI.BindingComboBox();
      ...
      // _binding
      // 
      this._binding.DataSource = typeof(JiraGit.Plugin.UI.IssuesListView);
      // 
      ...
      this.PerformLayout();
		...
		private JiraGit.Plugin.UI.BindingComboBox _filters;
		private System.Windows.Forms.TextBox _search;
		private JiraGit.Plugin.UI.BindingComboBox _status;
		private JiraGit.Plugin.UI.BindingComboBox _assigned;
		...
		private JiraGit.Plugin.UI.BindingComboBox _takeAction;
        private JiraGit.Plugin.UI.BindingComboBox _assignTo;
