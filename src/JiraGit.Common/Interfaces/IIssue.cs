...
namespace JiraGit.Common.Interfaces
{
    ///<summary>
	...
	public interface IIssue : IIdentifiable
	{
		...
		void ProcessWorklog(string timeSpent, TimeEstimateRecalcualationMethod method, string newTimeEstimate,string comment = "Time Logged");
	}
}
